const darkJson = {
    ...
    "layers": [
        ...
        },
        {
            ...
            "maxzoom": 24,
            "layout": { "visibility": "visible" },
            "paint": { "background-color": "rgba(19, 25, 37, 1)" }
        },
        {
            "id": "Positron-dark",
            "type": "raster",
        ...
        },
        {
            ...
            "maxzoom": 16,
            "layout": { "visibility": "visible" },
            "paint": { "fill-color": "rgba(115, 143, 159, 1)" }
        },
        {
            "id": "TN_RIVER_BNDRY",
            "type": "fill",
        ...
        },
        {
            ...
            "minzoom": 15,
            "layout": { "visibility": "visible" },
            "paint": { "fill-color": "rgba(70, 85, 114, 1)" }
        },
        {
            "id": "TN_EX_LOCALRDA_A",
            "type": "fill",
        ...
        },
        {
            ...
            "paint": {
                "fill-color": {
                    ...
                    "type": "categorical",
                    "stops": [
                        ["PRF028", "rgba(70, 85, 114, 1)"],
                        ["PRF009", "rgba(70, 85, 114, 1)"],
                        ["PRF010", "rgba(70, 85, 114, 1)"],
                        ["PRF011", "rgba(70, 85, 114, 1)"],
                        ["PRF015", "rgba(70, 85, 114, 1)"],
                        ["PRF012", "rgba(70, 85, 114, 1)"],
                        ["PRF016", "rgba(70, 85, 114, 1)"],
                        ["PRF013", "rgba(70, 85, 114, 1)"]
                    ],
                    "default": "rgb(19,27,44)"
                },
                "fill-outline-color": "rgba(70, 85, 114, 1)"
            }
        },
        {
